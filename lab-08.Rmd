...
```{r}
rain_pred <- predict(rain_reg, weather_Portland, type = "prob") %>%
...
```{r}
rain_split <- initial_split(weather_Portland, prop = 0.80)
train_data <- training(rain_split)
test_data <- testing(rain_split)
```
